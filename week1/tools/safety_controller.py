...
class safety_controller:
	...
	mid_data_range = np.array(laser_ranges[int(laser_ranges.size/2)-20 : int(laser_ranges.size/2)+20])
        ...
        if mid_data_point< self.distance_threshold or mid_data_point== 200 :   
            self.stop = True  
        else: 
            self.stop = False      
