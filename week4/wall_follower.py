...
steering_angle_turn_pid = Pid_Controller(1/25.0, 0, 0)
steering_angle_straight_pid = Pid_Controller(1, 0, 0.3)
...
while not rospy.is_shutdown():
    ...
    turn_visible = bool(laser_ranges[720] > laser_ranges[1080]*2)
    ...
    if turn_visible:
        ...
        msg.drive.speed = 2
        msg.drive.steering_angle = -steering_angle_turn_pid.calculate(45, np.degrees(A)) + -0.1
        ...
        msg.drive.speed = 2
        msg.drive.steering_angle = -steering_angle_straight_pid.calculate(2, c)
        print msg.drive.steering_angle
        print 'Forward'
